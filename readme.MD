...
About network settings for database and redis services: The app service needed to access databases and redis on localhost (127.0.0.1) and this achieved by using **network_mode: "service:[service name]"** option.
