...
About network settings for the database and redis services: The app service needed to access databases and redis on localhost (127.0.0.1) and this achieved by using **network_mode: "service:[service name]"** option.

The development performance and overall rails performance is acceptable. I can say that I feel there no big difference compared to the development on the MacBook Pro I normally used for Rails development at the office. The hardware components of the hosts (CPU, SSD, RAM) are approximately the same. 
